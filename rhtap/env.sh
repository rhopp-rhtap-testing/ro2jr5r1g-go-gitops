...
export GITOPS_REPO_URL=https://github.com/rhopp-rhtap-testing/ro2jr5r1g-go-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rhopp241205a.devcluster.openshift.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rhopp241205a.devcluster.openshift.com}
